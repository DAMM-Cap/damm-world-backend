...
@router.get("/lagoon/integrated/test/{address}/{vault_address}")
def read_integrated_position_test(
    ...
    result = get_integrated_position(address, offset, limit, chain_id, vault_address)
    return result
...
def read_integrated_position(
    ...
    result = get_integrated_position(current_user["address"], offset, limit, chain_id, vault_address)
    return result
